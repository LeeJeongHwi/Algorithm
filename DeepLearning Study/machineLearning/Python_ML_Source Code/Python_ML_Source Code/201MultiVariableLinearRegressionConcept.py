...
Button(main,text='Learning',height=2,command=learning()).grid(row=2,column=0,columnspan=4)

grad_canvas = FigureCanvasTkAgg(grad_fig,main)
grad_canvas.get_tk_widget().grid(row=3,column=0,sticky=(N,S,W,E))
